    ...
    options.registry.hotspotSetting = options.Class.extend({
        ...
        async setImgHotspot(previewMode, widgetValue, params) {
            if (widgetValue == 'enabled') {
                ...
                this.$target.parent().append('<section contenteditable="false" name="Hotspot-Block" data-exclude=".s_col_no_resize, .s_col_no_bgcolor" class="hotspot_draggable hotspot_element o_not_editable s_col_no_resize s_col_no_bgcolor fade_hotspot circle"><span class="hotspot_dot" draggable="true"> </span></section>')
