...
class SearchKeywordReport(models.Model):
    ...
    search_term = fields.Char(string='Search Keyword',
                              help='Search term used while searching on website.', required=True)
    no_of_products_in_result = fields.Integer(
        string='Number of Products in Result', group_operator=False,
